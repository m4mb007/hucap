class ParticipantsController < ApplicationController
  ...
  def download
    ...
    participant.text @participant.name,align: :center
    participant.text @participant.ics_no
  ...
  private
    ...
    def participant_params
      params.require(:participant).permit(:name, :ics_no, :course, :course_category_id)
    end
end
