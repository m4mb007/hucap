...
class ParticipantsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create participant" do
    assert_difference("Participant.count") do
      post participants_url, params: { participant: { course: @participant.course, ics_no: @participant.ics_no, name: @participant.name } }
    end
  ...
  test "should update participant" do
    patch participant_url(@participant), params: { participant: { course: @participant.course, ics_no: @participant.ics_no, name: @participant.name } }
